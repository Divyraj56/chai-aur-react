...
const copyPasswordToClipboard = useCallback(()=>{
  ...
  passwordRef.current?.setSelectionRange(0,20) //to select limited 
  window.navigator.clipboard.writeText(password)
	...
	return (
		<>
          ...
          className="bg-blue-400 text-white rounded-lg mx-4">copy</button>
				</div>
				<div className="flex text-sm gap-x-2 mt-4 mb-4 pb-6">
